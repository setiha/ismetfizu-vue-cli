<template>
  <div class="row py-5 mx-4">
    ...
    <div class="col-12 col-md-7 py-md-3">
      <p>
        Figyelembe véve a munkakörét és a hozzá tartozó feladatait, mennyire
        elégett a fizetésével?
      </p>
    </div>
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <select class="custom-select">
    ...
    <div class="col-12 col-md-7 py-md-3">
      <p>
        otthagyná-e jelenlegi munkahelyét, ha egy másik cég nagyobb fizetést
        ajánlana?
      </p>
    </div>
    <div class="col-12 col-md-5 py-md-3 mb-3">
    ...
    <div class="col-12 col-md-7 py-md-3">
      <p>
        Ön szerint mennyi tanulás szükséges ahhoz, hogy valaki teljes
        hatékonysággal tudja az Ön munkáját ellátni?
      </p>
    </div>
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <select class="custom-select">
    ...
    <div class="col-12 col-md-7 py-md-3">
      <p>
        Milyen hosszúságú továbbképzéseken vett részt önköltséges alapon az
        elmúlt egy évben?
      </p>
    </div>
    <div class="col-12 col-md-5 py-md-3 mb-3">
